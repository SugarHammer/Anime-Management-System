	...
	<div class="container">
		...
		<!-- 视频轮播图 [[ -->
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				  ...
				  <div class="carousel-inner" role="listbox">
				    <div class="item active">
				      <a href="#!"><img src="${pageContext.request.contextPath }/${requestScope.videoShows[0].src} " alt="${requestScope.videoShows[0].title}"></a>
				      <div class="carousel-caption">
					    <p>${requestScope.videoShows[0].title}</p>
					  </div>
				    </div>
				    <div class="item">
				       <a href="#!"><img src="${pageContext.request.contextPath }/${requestScope.videoShows[1].src}" alt="${requestScope.videoShows[1].title}"></a>
				      <div class="carousel-caption">
					    <p>${requestScope.videoShows[1].title}</p>
					  </div>
				    </div>
				   	<div class="item">
				       <a href="#!"><img src="${pageContext.request.contextPath }/${requestScope.videoShows[2].src}" alt="${requestScope.videoShows[2].title}"></a>
				      <div class="carousel-caption">
					    <p>${requestScope.videoShows[2].title}</p>
					  </div>
				    </div>
				  </div>
				</div>
			...
			<div class="col-lg-6 col-md-12 hidden-xs">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><a href="index-play-show?id=${requestScope.videos[0].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[0].src })"></div></a></div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><a href="index-play-show?id=${requestScope.videos[1].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[1].src })"></div></a></div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><a href="index-play-show?id=${requestScope.videos[2].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[2].src })"></div></a></div>
				</div>
				<br>
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><a href="index-play-show?id=${requestScope.videos[3].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[3].src })"></div></a></div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><a href="index-play-show?id=${requestScope.videos[4].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[4].src })"></div></a></div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><a href="index-play-show?id=${requestScope.videos[5].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[5].src })"></div></a></div>
				</div>
			</div>
			<div class="col-lg-6 col-md-12 visible-xs">
			<br>
				<div class="row">
					<div class="col-xs-6"><a href="index-play-show?id=${requestScope.videos[0].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[0].src })"></div></a></div>
					<div class="col-xs-6"><a href="index-play-show?id=${requestScope.videos[1].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[1].src })"></div></a></div>
				</div>
				<br>
				<div class="row">
					<div class="col-xs-6"><a href="index-play-show?id=${requestScope.videos[2].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[2].src })"></div></a></div>
					<div class="col-xs-6"><a href="index-play-show?id=${requestScope.videos[3].id }"><div class="topPhoto" style="background-image: url(${pageContext.request.contextPath}/${requestScope.videos[3].src })"></div></a></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-3">
			    <a href="index-play-show?id=${v.id }" class="thumbnail">
			      ...
			      <div class="caption">
			        ...
			        <p class="text-center" style="color:grey; font-size: 13px;"><fmt:formatDate value="${v.createTime }" pattern="yyyy-MM-dd hh:mm:ss"/> </p>
			      </div>
			    </a>
		</div>
