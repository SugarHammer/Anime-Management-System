	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-lg-offset-1">
					<br><br><br><br>
				  <h3><img src="${pageContext.request.contextPath }/photo/index/title_logo.png" width="50" height="35""></img>登录 <span style="font-weight: bold;" class="css716dd981b5489">国产动漫平台</span></h3>
				  <div class="form-group">
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm" id="myModal">Admin Login</button>
